...
class PrivateRecipeApiTests(TestCase):
    ...
    def test_create_tag_on_update(self): # when we use many to many filed we don't need to refresh db
    ...
    def test_create_recipe_with_new_ingredients(self):
        ...
        payload = {
            ...
            'time_minutes':30,
            'price':Decimal('3.50'),
            'ingredients': [{'name':'Cauliflower'},{'name':'salat'}],
        }
        res = self.client.post(RECIPES_URL, payload, format='json')
    ...
    def test_create_ingredient_on_update(self): # when we use many to many filed we don't need to refresh db
    ...
    def test_clear_recipe_ingredient(self):
        """Test clearing a ingredients tags"""
...
class ImageUploadTest(TestCase):
    ...
    def tearDown(self): #run after the test because we didn't need to upload image after any test case
